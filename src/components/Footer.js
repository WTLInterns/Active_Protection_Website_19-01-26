        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-300 text-sm leading-relaxed">
              Active Protection provides comprehensive security and housekeeping services 
              to ensure safety and cleanliness for your business and residential needs.
            </p>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/training" className="text-gray-300 hover:text-orange-500 transition-colors">
                  Training
                </Link>
              </li>
              <li>
                <Link href="/clients" className="text-gray-300 hover:text-orange-500 transition-colors">
                  Our Clients
                </Link>
              </li>
              <li>
          ...
          <div className="space-y-4">
            ...
            <ul className="space-y-2">
              <li className="text-gray-300 hover:text-orange-500 transition-colors cursor-pointer">
                Security Services
              </li>
              <li className="text-gray-300 hover:text-orange-500 transition-colors cursor-pointer">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                ...
                <div>
                  <p className="text-gray-300">123, Business Park, Sector 15</p>
                  <p className="text-gray-300">Gurugram, Haryana 122001</p>
                </div>
              </div>
              ...
              <div className="flex items-center space-x-3">
                ...
                <p className="text-gray-300">info@activeprotection.in</p>
              </div>
            </div>
          </div>
        </div>
