    ...
    <footer className="bg-[#1a0f08] text-gray-300">
      ...
      <div className="border-b border-gray-700">
        <div className="container mx-auto px-12 py-3 flex justify-between items-center">
          <a href="#top" className="text-orange-500 hover:text-orange-400 flex items-center text-sm">
            Back to Top
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          ...
          <div className="space-y-4">
            <div>
              ...
              <p className="text-sm">info@activeprotection.com</p>
            </div>
        ...
        <div className="container mx-auto px-12 py-3">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex space-x-6 text-sm">
              ...
              <Link href="#" className="hover:text-orange-500 transition-colors">Disclaimer</Link>
            </div>
